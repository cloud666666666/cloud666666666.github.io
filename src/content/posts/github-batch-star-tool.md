...
- GitHub:[star-assistant](https://github.com/cloud666666666/star-assistant)(朋友 [nbsheep](https://github.com/nbsheep) 的项目,我已 fork)

> 文末彩蛋:写完命令行版后,朋友 [nbsheep](https://github.com/nbsheep) 把它做成了 Windows 桌面小工具(GUI + 设备配对登录 + 凭据加密 + 代理回退),体验完胜命令行。这篇写命令行思路,桌面版是他(也是我)的主推版本——同一个痛点,两种解法,朋友间的"同题共创"。
